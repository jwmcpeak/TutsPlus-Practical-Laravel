  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        @if (Auth::check())
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Home">
        <a a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseTickets" data-parent="#exampleAccordion">
            <i class="fa fa-fw"></i>
            <span class="nav-link-text">
              Tickets</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseTickets">
            ...
            <li>
            <a href="{{ url('/tickets') }}">View Your Tickets</a>
            </li>
          </ul>
      </li>
